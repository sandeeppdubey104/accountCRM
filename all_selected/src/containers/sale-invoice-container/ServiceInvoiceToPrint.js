...
class ServiceInvoiceToPrint extends React.Component {
    render() {
        const border = {
            border: "solid 1px",
            width: " 50%",
                ...
                <div>
                    <Table>
                        ...
                        <tbody>
                            ...
                            <tr>
                                <th scope="row" colSpan="5" style={{ textAlign: "right" }}>Total</th>
                                <td>1,39,836.00</td>
                            </tr>
                            <tr>
                                <th scope="row" colSpan="5" style={{ textAlign: "right" }}>Add : CGST 9.00 %</th>
                                <td>12,585.24</td>
                            </tr>
                            <tr>
                                <th scope="row" colSpan="5" style={{ textAlign: "right" }}>Add : SGST 9.00 %</th>
                                <td>12,585.24</td>
                            </tr>
                            <tr>
                                <th scope="row" colSpan="5" style={{ textAlign: "right" }}>Grand Total</th>
                                <td colSpan="1">1,65,006.48</td>
                            </tr>
                        </tbody>
                    </Table>
...
export default ServiceInvoiceToPrint;