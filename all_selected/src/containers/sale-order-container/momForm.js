...
import QuotationToPrint from "../mom-container/QuotationToPrint";
        ...
        <div>
            <div className="card">
                <div className="card-body">
                    <h5 className="card-title">Sale Order Details</h5>
                    <Form>
                        ...
                        <div className="form-row">
                            <div className="form-group col-md-12">
                                <label>Proposal Text(Displayed at the Top of the Quote)</label>
                                <FormikTextarea
                                    name="header"
                                    className="form-control"
                                    rows="8"
                                    cols="12"
                                    placeholder="Displayed at the Top of the Quote."
                                />
                            </div>
                            <div className="form-group col-md-12">
                                <label>Customer Notes (Displayed at the Footer of the Quote)</label>
                                <FormikTextarea
                                    name="footer"
                                    className="form-control"
                                    rows="8"
                        ...
                        <div className="text-center py-4 mt-3">
                            <FormikCreateSearchClear
                                ...
                                values={values}
                            />
                            <QuotationToPrint ref={componentRef} />
