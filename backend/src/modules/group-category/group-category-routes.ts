...
const PATH_PREFIX: string = "/group-category";

export default class GroupCategoryRoutes extends AbstractRoutes {
  public route() {
    this.router.post(
      `${PATH_PREFIX}/search`,
      async (req: Request, res: Response) => {
        try {
          const controller = new GroupCategoryController(getMongoConnection());
