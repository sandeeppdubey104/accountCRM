...
const PATH_PREFIX: string = "/transporter";

export default class TrasporterRoutes extends AbstractRoutes {
  public route() {
    this.router.post(
      `${PATH_PREFIX}/search`,
      async (req: Request, res: Response) => {
        try {
          const controller = new TransporterController(getMongoConnection());
